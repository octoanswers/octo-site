...
class Newest_Questions_PageController extends Abstract_PageController
{
    ...
    {
        return _('Newest questions').' - '.$this->translator->get('page').' '.$this->page.' - '.$this->translator->get('answeropedia');
    }

    public function _getPageDescription(): string
    {
        $description = _('Newest questions').' - '.$this->translator->get('page').' '.$this->page.' - '.$this->translator->get('answeropedia');
