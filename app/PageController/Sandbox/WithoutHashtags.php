...
class WithoutHashtags_Sandbox_PageController extends Abstract_PageController
{
    ...
    {
        return _('Questions without hashtags').' - '.$this->translator->get('page').' '.$this->page.' - '.$this->translator->get('answeropedia');
    }

    public function _getPageDescription(): string
    {
        $description = _('Questions without hashtags').' - '.$this->translator->get('page').' '.$this->page.' - '.$this->translator->get('answeropedia');
