...
class PerPageTest extends TestCase
{
    public function test__PerPage_param_equal_zero()
    {
        ...
        $ERs = (new \Query\Relations\CategoriesToQuestions('ru'))->findNewestForCategoryWithID(13, 1, 0);
    }
    ...
    public function test__PerPage_param_below_zero()
    {
        ...
        $ERs = (new \Query\Relations\CategoriesToQuestions('ru'))->findNewestForCategoryWithID(13, 1, -1);
    }
    ...
    public function test__PerPage_param_below_min_value()
    {
        ...
        $ERs = (new \Query\Relations\CategoriesToQuestions('ru'))->findNewestForCategoryWithID(13, 1, 4);
    }
    ...
    public function test__PerPage_param_greater_than_100()
    {
        ...
        $ERs = (new \Query\Relations\CategoriesToQuestions('ru'))->findNewestForCategoryWithID(13, 1, 101);
    }
}
