...
class Sandbox_URL_Helper__getWithoutAnswersURL__Test extends PHPUnit\Framework\TestCase
{
    public function test_withoutPage()
    {
        ...
        $this->assertEquals('http://octoanswers.com/ru/sandbox/without-answers', $url);
    }
    ...
    public function test_en_1()
    {
        ...
        $this->assertEquals('http://octoanswers.com/en/sandbox/without-answers', $url);
    }

    public function test_13()
    {
        $url = Sandbox_URL_Helper::getWithoutAnswersURL('en', 13);
        $this->assertEquals('http://octoanswers.com/en/sandbox/without-answers?page=13', $url);
    }
}
