...
class Sandbox_URL_Helper__getAllURL__Test extends PHPUnit\Framework\TestCase
{
    public function test_withoutPage()
    {
        ...
        $this->assertEquals('https://octoanswers.com/ru/sandbox/all', $url);
    }
    ...
    public function test_en_1()
    {
        ...
        $this->assertEquals('https://octoanswers.com/en/sandbox/all', $url);
    }

    public function test_13()
    {
        $url = Sandbox_URL_Helper::getAllURL('en', 13);
        $this->assertEquals('https://octoanswers.com/en/sandbox/all?page=13', $url);
    }
}
