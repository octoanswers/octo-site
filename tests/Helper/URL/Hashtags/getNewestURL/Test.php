...
class Topics_URL_Helper__getNewestURL__Test extends PHPUnit\Framework\TestCase
{
    public function test_withoutPage()
    {
        ...
        $this->assertEquals('https://answeropedia.org/ru/topics/newest', $url);
    }
    ...
    public function test_en_1()
    {
        ...
        $this->assertEquals('https://answeropedia.org/en/topics/newest', $url);
    }

    public function test_13()
    {
        $url = Topics_URL_Helper::getNewestURL('en', 13);
        $this->assertEquals('https://answeropedia.org/en/topics/newest?page=13', $url);
    }
}
