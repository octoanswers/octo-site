...
class Questions_URL_Helper__getRecentlyUpdatedURL__Test extends PHPUnit\Framework\TestCase
{
    public function test_withoutPage()
    {
        ...
        $this->assertEquals('https://octoanswers.com/en/questions/recently-updated', $url);
    }
    ...
    public function test_13()
    {
        ...
        $this->assertEquals('https://octoanswers.com/en/questions/recently-updated?page=2', $url);
    }
}
