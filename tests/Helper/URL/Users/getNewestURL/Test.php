...
class Users_URL_Helper__getNewestURL__Test extends PHPUnit\Framework\TestCase
{
    public function test_withoutPage()
    {
        ...
        $this->assertEquals('http://octoanswers.com/ru/users/newest', $url);
    }
    ...
    public function test_en_1()
    {
        ...
        $this->assertEquals('http://octoanswers.com/en/users/newest', $url);
    }

    public function test_13()
    {
        $url = Users_URL_Helper::getNewestURL('en', 13);
        $this->assertEquals('http://octoanswers.com/en/users/newest?page=13', $url);
    }
}
