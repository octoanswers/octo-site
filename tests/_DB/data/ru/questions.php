...
$pdo->query(
    ...
    (6, 'Как птицы помечают свою территорию?', 0, '4_2013_05_09_123', 'Птицы не помечают свою территорию.', '[\"iphone8\",\"apple\"]', 0, '2015-11-29 09:28:34'),
    ...
    (30, 'Что означает FILE_NAME?', 0, NULL, NULL, NULL, 0, '2015-11-29 09:28:34'),
