...
class Validator_Redirect_Category__validate__negative__to_titleTest extends PHPUnit\Framework\TestCase
{
    public function test__Title_not_set()
    {
        ...
        $this->expectExceptionMessage('Category_Redirect_Model property "to_title" null must be a string');
    ...
    public function test__Title_is_empty()
    {
        ...
        $this->expectExceptionMessage('Category_Redirect_Model property "to_title" "" must have a length between 3 and 255');
        $this->assertEquals(true, Category_Redirect_Validator::validate($redirect));
    }
    ...
    public function test__Comment_too_short()
    {
        ...
        $this->expectExceptionMessage('Category_Redirect_Model property "to_title" "x?" must have a length between 3 and 255');
        $this->assertEquals(true, Category_Redirect_Validator::validate($redirect));
    }
    ...
    public function test__Comment_too_long()
    {
        ...
        $this->expectExceptionMessage('Category_Redirect_Model property "to_title" "Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42. Title42." must have a length between 3 and 255');
        $this->assertEquals(true, Category_Redirect_Validator::validate($redirect));
    }
}
