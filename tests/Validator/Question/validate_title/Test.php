...
class Validator_Question__validate_titleTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals(null, \Validator\Question::validate_title('Как пятница?'));
    }

    public function test__Validate_EN_title()
    {
        $this->assertEquals(null, \Validator\Question::validate_title('Как ты, Маша?'));
    }
    ...
    public function test__Title_begin_plus_sign()
    {
        ...
        $this->assertEquals(null, \Validator\Question::validate_title('+Как ты?'));
    }
}
