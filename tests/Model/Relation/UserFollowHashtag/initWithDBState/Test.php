...
class UserFollowCategory_Relation_Model__initWithDBState__Test extends PHPUnit\Framework\TestCase
{
    public function test__EnFullParams_ReturnObject()
    {
        $rel = UserFollowCategory_Relation_Model::initWithDBState([
            'id' => 13,
            'user_id' => 3,
            'category_id' => 9,
