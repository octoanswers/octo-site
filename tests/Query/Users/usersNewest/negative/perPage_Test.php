...
class Query_Users_usersNewest_negative_perPage_Test extends Abstract_DB_TestCase
{
    public function testPerPageEqualZero()
    {
        ...
        $actualResponse = (new Users_Query())->usersNewest(0, 4);
    }
    ...
    public function testPerPageBelowZero()
    {
        ...
        $actualResponse = (new Users_Query())->usersNewest(0, -1);
    }
    ...
    public function testPerPageGreaterThan100()
    {
        ...
        $users = (new Users_Query())->usersNewest(0, 101);
    }
}
