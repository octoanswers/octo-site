...
class Query_ER_HashtagsQuestions__findNewestForhashtagWithID__page__Test extends TestCase
{
    public function test__PageEqualZero()
    {
        ...
        $ERs = (new HashtagsToQuestions_Relations_Query('ru'))->findNewestForhashtagWithID(13, 0);
    }
    ...
    public function test__PageBelowZero()
    {
        ...
        $ERs = (new HashtagsToQuestions_Relations_Query('ru'))->findNewestForhashtagWithID(13, -1);
    }
    ...
    public function test__PageGreaterThan9999()
    {
        ...
        $ERs = (new HashtagsToQuestions_Relations_Query('ru'))->findNewestForhashtagWithID(13, 10000);
    }
}
