...
class Query_ER_CategoriesQuestions__findNewestForcategoryWithID__page__Test extends TestCase
{
    public function test__PageEqualZero()
    {
        ...
        $ERs = (new CategoriesToQuestions_Relations_Query('ru'))->findNewestForcategoryWithID(13, 0);
    }
    ...
    public function test__PageBelowZero()
    {
        ...
        $ERs = (new CategoriesToQuestions_Relations_Query('ru'))->findNewestForcategoryWithID(13, -1);
    }
    ...
    public function test__PageGreaterThan9999()
    {
        ...
        $ERs = (new CategoriesToQuestions_Relations_Query('ru'))->findNewestForcategoryWithID(13, 10000);
    }
}
