...
class Query_ER_TopicsQuestions__findNewestFortopicWithID__per_page__Test extends TestCase
{
    public function test_PerPageParamEqualZero_ThrowException()
    {
        ...
        $ERs = (new TopicsToQuestions_Relations_Query('ru'))->findNewestFortopicWithID(13, 1, 0);
    }
    ...
    public function test_PerPageParamBelowZero_ThrowException()
    {
        ...
        $ERs = (new TopicsToQuestions_Relations_Query('ru'))->findNewestFortopicWithID(13, 1, -1);
    }
    ...
    public function test_PerPageParamBelowMinValue_ThrowException()
    {
        ...
        $ERs = (new TopicsToQuestions_Relations_Query('ru'))->findNewestFortopicWithID(13, 1, 4);
    }
    ...
    public function test_PerPageParamGreaterThan100_ThrowException()
    {
        ...
        $ERs = (new TopicsToQuestions_Relations_Query('ru'))->findNewestFortopicWithID(13, 1, 101);
    }
}
