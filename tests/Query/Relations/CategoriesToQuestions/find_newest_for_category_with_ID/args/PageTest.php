...
class PageTest extends TestCase
{
    public function test__Page_param_equal_zero()
    {
        ...
        $ERs = (new \Query\Relations\CategoriesToQuestions('ru'))->find_newest_for_category_with_ID(13, 0);
    }
    ...
    public function test__Page_param_below_zero()
    {
        ...
        $ERs = (new \Query\Relations\CategoriesToQuestions('ru'))->find_newest_for_category_with_ID(13, -1);
    }
    ...
    public function test__Page_param_greater_than_9999()
    {
        ...
        $ERs = (new \Query\Relations\CategoriesToQuestions('ru'))->find_newest_for_category_with_ID(13, 10000);
    }
}
