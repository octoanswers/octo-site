...
class Categories_Query__findNewest_perPage_Test extends TestCase
{
    public function test_PerPageParamEqualZero_ThrowException()
    {
        ...
        $categories = (new Categories_Query('ru'))->findNewest(1, 0);
    }
    ...
    public function test_PerPageParamBelowZero_ThrowException()
    {
        ...
        $categories = (new Categories_Query('ru'))->findNewest(1, -1);
    }
    ...
    public function test_PerPageParamBelowMinValue_ThrowException()
    {
        ...
        $categories = (new Categories_Query('ru'))->findNewest(1, 4);
    }
    ...
    public function test_PerPageParamGreaterThan100_ThrowException()
    {
        ...
        $categories = (new Categories_Query('ru'))->findNewest(1, 101);
    }
}
