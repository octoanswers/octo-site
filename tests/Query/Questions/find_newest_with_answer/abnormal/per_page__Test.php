...
class Query_Questions__find_newest_with_answer__negative__per_pageTest extends Abstract_DB_TestCase
{
    public function test__PerPage_param_equal_zero()
    {
        ...
        $questions = (new Questions_Query('ru'))->find_newest_with_answer(1, 0);
    }
    ...
    public function test__PerPage_param_below_zero()
    {
        ...
        $questions = (new Questions_Query('ru'))->find_newest_with_answer(1, -1);
    }
    ...
    public function test__PerPage_param_below_min_value()
    {
        ...
        $questions = (new Questions_Query('ru'))->find_newest_with_answer(1, 4);
    }
    ...
    public function test__PerPage_param_greater_than_100()
    {
        ...
        $questions = (new Questions_Query('ru'))->find_newest_with_answer(1, 101);
    }
}
