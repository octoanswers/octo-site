...
class Query_Questions__find_newest_with_answer__negative__pageTest extends \Tests\DB\TestCase
{
    public function test__Page_param_equal_zero()
    {
        ...
        $questions = (new \Query\Questions('ru'))->find_newest_with_answer(0);
    }
    ...
    public function test__Page_param_greater_than_9999()
    {
        ...
        $questions = (new \Query\Questions('ru'))->find_newest_with_answer(10000);
    }
}
