...
class Query_Questions_findNewest_negative_Page_Test extends Abstract_DB_TestCase
{
    public function testPageEqualZero()
    {
        ...
        $questions = (new Questions_Query('ru'))->findNewest(0);
    }
    ...
    public function testPageGreaterThan9999()
    {
        ...
        $questions = (new Questions_Query('ru'))->findNewest(10000);
    }
}
