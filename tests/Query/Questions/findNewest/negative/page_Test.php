...
class Query_Questions_find_newest_negative_Page_Test extends Abstract_DB_TestCase
{
    public function testPageEqualZero()
    {
        ...
        $questions = (new Questions_Query('ru'))->find_newest(0);
    }
    ...
    public function testPageBelowZero()
    {
        ...
        $questions = (new Questions_Query('ru'))->find_newest(-1);
    }
    ...
    public function testPageGreaterThan9999()
    {
        ...
        $questions = (new Questions_Query('ru'))->find_newest(10000);
    }
}
