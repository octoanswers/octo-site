...
class Trait_Model_Relation_UserFollowCategory__init_with_DB_state__Test extends PHPUnit\Framework\TestCase
{
    public function test__EnFullParams_ReturnObject()
    {
        $rel = \Model\Relation\UserFollowCategory::init_with_DB_state([
            'id'          => 13,
            'user_id'     => 3,
            'category_id' => 9,
