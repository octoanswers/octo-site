...
class Question_URL_Trait__getURL__Test extends PHPUnit\Framework\TestCase
{
    public function test_baseURI()
    {
        ...
        $this->assertEquals('https://octoanswers.com/en/19/how-iphone-8-are-charged', $question->getURL('en'));
    }
    ...
    public function test_RuTitle()
    {
        ...
        $this->assertEquals('https://octoanswers.com/ru/18/mozhno-li-sohranit-massiv-v-cookie', $question->getURL('ru'));
    }
}
